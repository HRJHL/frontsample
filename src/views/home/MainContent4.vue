<template class="tem">
  <section class="px-[12.5%] py-[225px] bg-white text-black flex flex-col justify-center items-center">
    ...
    <article class="flex w-full flex-row lg:flex-col md:flex-col sm:flex-col items-center gap-[44px] mb-[44px]">
      ...
      style="background-color: #DCEFF4">
        ...
        <div class="text-[34px] zl:text-[25px] xl:text-[20px] md:text-[25px] sm:text-[20px] font-bold mb-[60px] xl:mb-[30px]"
        style="color: #516B71">
      ...
      style="background-color: #FBFBEF">
        <div class="text-[34px] zl:text-[25px] xl:text-[20px] md:text-[25px] sm:text-[20px] font-bold"
        style="color: #431B06">
          <span class="">강력한 보안을 제공합니다.</span>
        </div>
        <div class="text-[34px] zl:text-[25px] xl:text-[20px] md:text-[25px] sm:text-[20px] font-bold mb-[50px]"
        style="color: #696156">
  ...
  style="background-color: #F8F9FA">
    ...
    <div class="text-[34px] zl:text-[25px] xl:text-[20px] md:text-[25px] sm:text-[15px] font-bold mb-[49px]"
    style="color:#727B88">
